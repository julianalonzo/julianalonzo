      ...
      <div className="container mx-auto my-12 w-11/12 sm:4/5 md:w-3/4 lg:w-3/5 xl:w-1/2">
        ...
        <div>
          ...
          <p className="font-sans leading-loose mb-8">
            kaagapAI uses IBM Watson Natural Language Understanding in order to
            perform text analysis on session documents (e.g., transcripts and
            notes). Through text analysis, kaagapAI extracts relevant insights
            which include keywords, themes or categories, entities, sentiments,
            and emotional tone. Text analysis can be conducted on a specific
            session or multiple sessions. Analysis on multiple sessions include
            data visualizations on sentiment and emotion trends.
          </p>
          <p className="font-sans leading-loose mb-8 mb-8">
            IBM Watson Knowledge Studio enables the training of custom models in
            order to extract domain-specific entities. The original intention
            was to train a custom model to extract more relevant entities in the
            mental health field (e.g., mental health disorders or more diversed
            emotional tones), however, the custom model still lacks training due
            to time constraints and resources constraints (i.e., lack of
            annotators and training dataset). kaagapAI is currently using the
            default model used by NLU.
          </p>
          <h4 className="font-sans text-gray-700 mb-1">
            Word Cloud (Keywords)
          </h4>
          <p className="font-sans leading-loose">
            The word cloud consists of the keywords that occurred multiple times
            in the document. Clicking on a specific word in the word cloud
            displays the word count and relevance and finds all search
          ...
          <p className="font-sans leading-loose">
            ...
            in the analyzed documents. These themes were derived from the words
          ...
          <p className="font-sans leading-loose">
            ...
            fear. In the analysis of multiple sessions, a line graph is used to
            show the trend of emotions across selected sessions.
          </p>
          <img
            className="border border-gray-300 rounded-lg mt-4 mb-8"
          ...
          <p className="font-sans leading-loose">
            <i>Sentiment</i> scores the overall feel of the session which could
            be positive, negative, or neutral. Analysis of multiple sessions
            also shows the trend of sentiments across selected sessions.
          </p>
          <img
            className="border border-gray-300 rounded-lg mt-4 mb-8"
          ...
          <p className="font-sans leading-loose">
            ...
            possible to upload handwritten notes, while Cloud Speech-to-Text API
            is used to transcribe audio recordings. After extracting text from
            uploaded files, the text is translated to English using the Cloud
            Translation API.
          </p>
          <img
            className="border border-gray-300 rounded-lg mt-4 mb-8"
