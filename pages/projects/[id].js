    ...
    <div className="bg-gray-100">
      ...
      <div className="container mx-auto mt-12 mb-64 w-11/12 sm:4/5 md:w-3/4 lg:w-3/5 xl:w-1/2">
        <div className="mb-8 md:inline-flex items-center">
          ...
          <button className="py-2 px-4 mr-2 uppercase inline-flex items-center bg-green-400 font-sans text-xs tracking-widest text-green-900 rounded-full outline-none focus:outline-none focus:shadow-outline shadow-md hover:shadow-lg hover:bg-green-500">
            <svg
          ...
          <button className="py-2 px-4 inline-flex items-center bg-yellow-400 font-sans text-xs tracking-widest text-yellow-900 rounded-full outline-none focus:outline-none focus:shadow-outline shadow-md hover:shadow-lg hover:bg-yellow-500 uppercase">
            <svg
              className="fill-current w-4 h-4 mr-1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
