    ...
    >
      <div className="container mx-auto">
        <div className="text-center pt-12 px-4 md:text-left md:px-12 md:pt-24">
          ...
          <button className="mt-4 py-2 px-4 bg-green-600 font-sans text-yellow-200 rounded-full outline-none hover:bg-green-700 focus:outline-none focus:shadow-outline md:inline md:text-lg">
            View Projects
          </button>
        </div>
      </div>
