...
export default function EIS() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      />
      <div className="animated fadeIn delay-1s container mx-auto my-12 w-11/12 sm:4/5 md:w-3/4 lg:w-3/5 xl:w-1/2">
        <ProjectTitle
        ...
        <div>
          ...
          <div className="mb-12">
            ...
            <p className="font-sans leading-loose mb-8">
              ...
              name, category, condition, and thumbnails are the default fields
              for an item, however, users may add custom fields of an item in
            ...
            <p className="font-sans leading-loose mb-8">
              ...
              For example, a laptop may have properties such as processor,
              storage capacity, and price. Users can define any property they
              want in order to represent any item.
            </p>
            <p className="font-sans leading-loose">
              ...
              message such as a message informing the user how an item was
              broken or who borrowed the equipment. Attachments are relevant
              files associated to an item. These files may be software license,
              receipts, and images.
            </p>
          </div>
          <div className="mb-12">
            ...
            <p className="font-sans leading-loose mb-8">
              ...
              together. Nesting folders is possible in order to support
              different ways to organize items. EIS also enables users to move
              items and folders into another folder in case an item was moved or
