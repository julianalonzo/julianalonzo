        ...
        <div className="container mx-auto my-12 w-11/12 sm:4/5 md:w-3/4 lg:w-3/5 xl:w-1/2">
          ...
          <div className="mb-10 inline-flex items-start">
            <p className="font-sans leading-loose">
              ...
              mental health practitioners in summarizing, analyzing, and
              managing therapy session documents.
            </p>
          </div>
          <div className="mb-10">
          ...
          <div>
            ...
            <div className="mb-12">
              ...
              <p className="font-sans leading-loose mb-8">
                ...
                sentiments, and emotional tone. Text analysis can be conducted
                on a specific session or multiple sessions. Analysis on multiple
              ...
              />
              <p className="font-sans leading-loose mb-8">
                IBM Watson Knowledge Studio enables the training of custom
                models in order to extract domain-specific entities. The
                original intention was to train a custom model to extract more
                relevant entities in the mental health field (e.g., mental
                health disorders or more diversed emotional tones), however, the
                custom model still lacks training due to time constraints and
                resources constraints (i.e., lack of annotators and training
                dataset). kaagapAI is currently using the default model used by
                NLU.
              </p>
              ...
              <p className="font-sans leading-loose mb-4">
                <i>Categories</i> shows the hierarchy of themes that were
                detected in the analyzed documents. These themes were derived
                from the words that were found in the documents.
              </p>
              <img
                className="shadow-md rounded-lg mb-8"
              ...
              <p className="font-sans leading-loose mb-4">
                <i>Emotions</i> rates the detected emotions of analyzed
                documents according to six basic emotions: joy, anger, disgust,
                sadness, and fear. In the analysis of multiple sessions, a line
                graph is used to show the trend of emotions across selected
                sessions.
              </p>
              <img
                className="shadow-md rounded-lg mb-8"
            ...
            <div className="mb-12">
              ...
              />
              <p className="font-sans leading-loose mb-8">
                kaagapAI preprocesses uploaded documents in order to extract
                text from different file formats (i.e., txt, pdf, docx, png,
                jpg, m4a). Cloud Vision API is used to extract text from images,
                thus making it possible to upload handwritten notes, while Cloud
            ...
            <div className="mb-12">
              ...
              <p className="font-sans leading-loose mb-8">
                kaagapAI organizes its data based on the common data
                organization of mental health practitioners. A client can have
                multiple sessions, and a session can hold multiple documents.
                kaagapAI provides CRUD operations in order to manage these
                entities (i.e., clients, sessions, and documents).
              </p>
              <img
                className="shadow-md rounded-lg mb-8"
              ...
              <p className="font-sans leading-loose">
                ...
                incorrect transcription. Files can be uploaded either as
                documents or attachments. Documents are files that are included
                in the analysis by default, while attachments are supporting
                files that are not excluded in the analysis. Documents can be
                set to ignored to exclude them from the analysis.
              </p>
            </div>
          </div>
        </div>
